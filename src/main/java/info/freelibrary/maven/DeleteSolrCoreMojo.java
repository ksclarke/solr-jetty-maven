...
public class DeleteSolrCoreMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (myCore.equals("collection1")) {
            throw new MojoExecutionException("Sorry, but you can't delete the default core");
        }
        ...
        try {
            ...
            throw new MojoExecutionException("Unable to delete the requested core directory: " +
